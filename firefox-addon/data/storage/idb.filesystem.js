...
(function(exports) {
    ...
    var log = function(msg)
    {
        ...
        {
            exports.postMessage({msg: 400, log: msg});
        }
    };
...
idb_.open = function(dbName, successCallback, opt_errorCallback) {
  ...
  request.onupgradeneeded = function(e) {
   ...
   // log('onupgradeneeded: oldVersion:' + e.oldVersion,
...
idb_.getAllEntries = function(fullPath, successCallback, opt_errorCallback) {
  ...
  if (fullPath != DIR_SEPARATOR) {
    //log(fullPath + '/', fullPath + DIR_OPEN_BOUND)
...
function onError(e) {
  switch (e.target.errorCode) {
    case 12:
      log('Error - Attempt to open db with a lower version than the ' +
                  'current one.');
      break;
    default:
...
if (typeof window !== "undefined" && exports === window && exports.RUNNING_TESTS) {
  exports['Entry'] = Entry;
